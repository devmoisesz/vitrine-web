...
export default function CheckoutPage() {
  ...
  if (carts.isError || profile.isError || addresses.isError) return <div className="min-h-screen bg-background"><Header /><main className="mx-auto max-w-3xl px-4 py-12 text-center md:px-8"><h1 className="font-display text-2xl font-semibold">Não foi possível preparar seu pedido</h1><p className="mt-2 text-sm text-muted-foreground">Atualize a página e tente novamente.</p></main></div>;
